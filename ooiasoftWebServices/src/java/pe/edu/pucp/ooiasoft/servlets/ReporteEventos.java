...
public class ReporteEventos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            //Referencia para el subreporte
            String rutaSubreporte1 = ReporteEventos.class.getResource("/pe/edu/pucp/ooiasoft/reportes/SubReporteEventos.jasper").getPath();
            //Referencia para el grafico
            String rutaGraf = ReporteEventos.class.getResource("/pe/edu/pucp/ooiasoft/reportes/SubRepEventosGrafico.jasper").getPath();
            
            //Arreglo de parametros que ingresan a la generación del reporte
            HashMap hm = new HashMap();
            hm.put("imagen", logo);
            hm.put("RutaSubReporte",rutaSubreporte1); 
            hm.put("rutaGrafico",rutaGraf); 
